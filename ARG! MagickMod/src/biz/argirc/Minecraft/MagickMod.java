...
public class MagickMod extends JavaPlugin {
	...
	public final BankFunctions					bankFunctions			= new BankFunctions(getDatabase());
	...
	public static final String					propertiesFile			= maindirectory + "MagickMod.conf";
	public static final String					shopFile				= maindirectory + "ItemShop.conf";
	public final PluginSettings					pluginSettings			= new PluginSettings(propertiesFile);
	public final ShopFunctions					shopFunctions			= new ShopFunctions(shopFile);
	...
	public void onEnable() {
		...
		getCommand("challange").setExecutor(new ChallangeCommand(this));
		getCommand("die").setExecutor(new DieCommand(this));
		getCommand("bank").setExecutor(new BankCommand(getDatabase()));
